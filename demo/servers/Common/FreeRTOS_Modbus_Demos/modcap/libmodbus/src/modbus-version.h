...
/**
 * Modified to hard-code the version number
 *
 * This is mostly laziness as I've shifted from autotools to ament-cmake.
 * There is probably a way to configure this, but I'm not botherint at this point
 *
 * 2020 Michael Dodson <md403@cam.ac.uk>
 * */
